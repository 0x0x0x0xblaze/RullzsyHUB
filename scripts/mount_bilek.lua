...
local jsonFolder = mainFolder .. "/json_mount_bilek_patch_001"
...
local baseURL = "https://raw.githubusercontent.com/0x0x0x0xblaze/RullzsyHUB/refs/heads/main/json/json_mount_bilek/"
local jsonFiles = {
    "spawnpoint.json",
    "checkpoint_1.json",
    "checkpoint_2.json",
    ...
    local function playNext()
        ...
        startPlayback(data, function()
            ...
            if nextIndex then
                ...
                Rayfield:Notify({
                    Title = "Auto Walk",
                    Content = "Semua checkpoint telah selesai! Silahkan click GUI TURUN Di pojok kanan bawah untuk kembali ke basecamp.",
                    Duration = 4,
                    Image = "check-check"
                })
                stopPlayback(true)
